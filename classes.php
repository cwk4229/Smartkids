...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <title>Smartkids, Wombourne - Class Times</title>
  ...
  <body style="">
    ...
    <div class="container">
      ...
      <div class="page-header" id="banner">
        <div class="row">
          <h1>Class Times</h1>
          <p class="lead">These are the times that our Centre is open and when your child may</p>
            </div>
          </div>
    <div class="container">
        <div class="row">
